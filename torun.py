...
def helpnote():
	...
	subprocess.check_output(["am", "start", "https://github.com/toruna810/torun/blob/main/torun.txt"])
...
class Main:
	def __init__(self):
		...
		self.loop = 0
		try:
			plr = requests.get('https://github.com/toruna810/torun/blob/main/torun.txt').text
			if basesplit in plr:
				key = basesplit
